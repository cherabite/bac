...
(function (global, factory) {
  ...
  var TodoList = function ($) {
    ...
    function () {
      ...
      _proto._init = function _init() {
        var that = this;
        $(Selector.DATA_TOGGLE).find('input class="permission":checkbox:checked').parents('li').toggleClass(ClassName.TODO_LIST_DONE);
        $(Selector.DATA_TOGGLE).on('change', 'input class="permission":checkbox', function (event) {
