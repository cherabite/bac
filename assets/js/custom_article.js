   ...
   if(num_article_val !='' && num_chapitre_val !='' ) {
    ...
    $(document).on('click', '.check_box', function () {
        ...
        if (this.checked) {
            ...
            html = '<td> <input  type="checkbox"  class="check_box"  id="' + $(this).attr('id') + ' "  data-budjet_primitif="' + $(this).data('budjet_primitif') + '"  data-fknum_section="' + $(this).data('fknum_section') + '"  data-fknum_chapitre="' + $(this).data('fknum_chapitre') + '"  data-fknum_article="' + $(this).data('fknum_article') + '"   data-libelle_article="' + $(this).data('libelle_article') + '" checked  /></td>';
            ...
            html += '<td><input   class="form-control input budjet" type="text"  required  data-decimals="2" style="color: red; font-weight: bold;text-align:center"  id="budjet_primitif" name="budjet_primitif[]" value="' + $(this).data("budjet_primitif") + '"  /> <input  type="hidden" name="depense_id[]" value="' + $(this).attr('id') + '" /></td>';


        } else {

            html = '<td> <input  type="checkbox"  class="check_box"  id="' + $(this).attr('id') + ' "  data-budjet_primitif="' + $(this).data('budjet_primitif') + '"  data-fknum_section="' + $(this).data('fknum_section') + '"  data-fknum_chapitre="' + $(this).data('fknum_chapitre') + '"  data-fknum_article="' + $(this).data('fknum_article') + '"   data-libelle_article="' + $(this).data('libelle_article') + '"   /></td>';
            html += '<td>' + $(this).data('fknum_section') + '</td>';
            html += '<td>' + $(this).data('fknum_chapitre') + '</td>';
            html += '<td>' + $(this).data('fknum_article') + '</td>';
            html += '<td>' + $(this).data('libelle_article') + '</td>';
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var count = 0; count < data.length; count++) {
                    html += '<tr>';
                    html += '<td> <input type="checkbox"  class="check_box"  id="' + data[count].id_engagement + '"  data-budjet_primitif="' + data[count].nouveau_montant + '"  data-fknum_section="' + data[count].fknum_section + '"  data-fknum_chapitre="' + data[count].fknum_chapitre + '"  data-fknum_article="' + data[count].fknum_article + '"   data-libelle_article="' + data[count].libelle_article + '"   /></td>';
