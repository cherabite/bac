$(document).ready(function() {
    ...
    $('.configurator input class="permission", .configurator select').change(function() {
      updateConfig();
    });

    $('.demo i').click(function() {
      $(this).parent().find('input class="permission"').click();
    });
    ...
    function updateConfig() {
      ...
      if (!$('#autoUpdateinput class="permission"').is(':checked'))
        options.autoUpdateinput class="permission" = false;
