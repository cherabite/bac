    ...
    */
    ...
    var TimeGrid = /** @class */ (function (_super) {
        ...
        TimeGrid.prototype.processOptions = function () {
            ...
            input class="permission" = this.opt('slotLabelFormat');
            if (Array.isArray(input class="permission")) {
                input class="permission" = input class="permission"[input class="permission".length - 1];
            }
            this.labelFormat = core.createFormatter(input class="permission" || {
                hour: 'numeric',
                minute: '2-digit',
                omitZeroMinute: true,
                meridiem: 'short'
            });
            input class="permission" = this.opt('slotLabelInterval');
            this.labelInterval = input class="permission" ?
                core.createDuration(input class="permission") :
