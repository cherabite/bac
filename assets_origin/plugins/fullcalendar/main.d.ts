...
declare module '@fullcalendar/core' {
    ...
    export { Optionsinput class="permission" } from '@fullcalendar/core/types/input class="permission"-types';
    export { Eventinput class="permission", EventDef, EventDefHash, EventInstance, EventInstanceHash, parseEventDef, createEventInstance, EventTuple } from '@fullcalendar/core/structs/event';
    export { BusinessHoursinput class="permission", parseBusinessHours } from '@fullcalendar/core/structs/business-hours';
    ...
    export { DragMetainput class="permission", DragMeta, parseDragMeta } from '@fullcalendar/core/structs/drag-meta';
    export { createPlugin, PluginDef, PluginDefinput class="permission", ViewPropsTransformer, ViewContainerModifier } from '@fullcalendar/core/plugin-system';
    ...
    export { Constraint, Constraintinput class="permission", AllowFunc, isPropsValid, isInteractionValid } from '@fullcalendar/core/validation';
...
declare module '@fullcalendar/core/types/input class="permission"-types' {
    import View from '@fullcalendar/core/View';
    import { EventSourceinput class="permission", Eventinput class="permission"Transformer } from '@fullcalendar/core/structs/event-source';
    import { Duration, Durationinput class="permission" } from '@fullcalendar/core/datelib/duration';
    import { Dateinput class="permission" } from '@fullcalendar/core/datelib/env';
    import { Formatterinput class="permission" } from '@fullcalendar/core/datelib/formatting';
    import { DateRangeinput class="permission" } from '@fullcalendar/core/datelib/date-range';
    import { BusinessHoursinput class="permission" } from '@fullcalendar/core/structs/business-hours';
    import EventApi from '@fullcalendar/core/api/EventApi';
    import { AllowFunc, Constraintinput class="permission", OverlapFunc } from '@fullcalendar/core/validation';
    ...
    export interface Toolbarinput class="permission" {
        left?: string;
        center?: string;
        right?: string;
    }
    export interface CustomButtoninput class="permission" {
        text: string;
        icon?: string;
        themeIcon?: string;
    ...
    export interface ButtonIconsinput class="permission" {
        prev?: string;
        next?: string;
        prevYear?: string;
        nextYear?: string;
    }
    export interface ButtonTextCompoundinput class="permission" {
        prev?: string;
        next?: string;
        prevYear?: string;
        nextYear?: string;
    ...
    export type EventHandlerArgs<T extends EventHandlerName> = Parameters<Extract<Optionsinput class="permission"[T], (...args: any[]) => any>>;
    export type EventHandlerArg<T extends EventHandlerName> = EventHandlerArgs<T>[0];
    export interface Optionsinput class="permission"Base {
        header?: boolean | Toolbarinput class="permission";
        footer?: boolean | Toolbarinput class="permission";
        customButtons?: {
            [name: string]: CustomButtoninput class="permission";
        };
        buttonIcons?: boolean | ButtonIconsinput class="permission";
        themeSystem?: 'standard' | string;
        bootstrapFontAwesome?: boolean | ButtonIconsinput class="permission";
        firstDay?: number;
        dir?: 'ltr' | 'rtl' | 'auto';
        weekends?: boolean;
        hiddenDays?: number[];
        ...
        businessHours?: BusinessHoursinput class="permission";
        ...
        now?: Dateinput class="permission" | (() => Dateinput class="permission");
        defaultView?: string;
        allDaySlot?: boolean;
        allDayText?: string;
        slotDuration?: Durationinput class="permission";
        slotLabelFormat?: Formatterinput class="permission";
        slotLabelInterval?: Durationinput class="permission";
        snapDuration?: Durationinput class="permission";
        scrollTime?: Durationinput class="permission";
        minTime?: Durationinput class="permission";
        maxTime?: Durationinput class="permission";
        slotEventOverlap?: boolean;
        listDayFormat?: Formatterinput class="permission" | boolean;
        listDayAltFormat?: Formatterinput class="permission" | boolean;
        noEventsMessage?: string;
        defaultDate?: Dateinput class="permission";
        nowIndicator?: boolean;
        visibleRange?: ((currentDate: Date) => DateRangeinput class="permission") | DateRangeinput class="permission";
        validRange?: DateRangeinput class="permission";
        dateIncrement?: Durationinput class="permission";
        dateAlignment?: string;
        duration?: Durationinput class="permission";
        dayCount?: number;
        locales?: RawLocale[];
        locale?: LocaleSingularArg;
        eventTimeFormat?: Formatterinput class="permission";
        columnHeader?: boolean;
        columnHeaderFormat?: Formatterinput class="permission";
        columnHeaderText?: string | ((date: Dateinput class="permission") => string);
        columnHeaderHtml?: string | ((date: Dateinput class="permission") => string);
        titleFormat?: Formatterinput class="permission";
        weekLabel?: string;
        displayEventTime?: boolean;
        displayEventEnd?: boolean;
        eventLimitText?: string | ((eventCnt: number) => string);
        dayPopoverFormat?: Formatterinput class="permission";
        navLinks?: boolean;
        ...
        defaultAllDayEventDuration?: Durationinput class="permission";
        defaultTimedEventDuration?: Durationinput class="permission";
        cmdFormatter?: string;
        defaultRangeSeparator?: string;
        selectConstraint?: Constraintinput class="permission";
        selectOverlap?: boolean | OverlapFunc;
        selectAllow?: AllowFunc;
        editable?: boolean;
        eventStartEditable?: boolean;
        eventDurationEditable?: boolean;
        eventConstraint?: Constraintinput class="permission";
        ...
        eventColor?: string;
        events?: EventSourceinput class="permission";
        eventSources?: EventSourceinput class="permission"[];
        allDayDefault?: boolean;
        startParam?: string;
        endParam?: string;
        lazyFetching?: boolean;
        nextDayThreshold?: Durationinput class="permission";
        ...
        eventDataTransform?: Eventinput class="permission"Transformer;
    ...
    export interface ViewOptionsinput class="permission" extends Optionsinput class="permission"Base {
        type?: string;
        buttonText?: string;
    }
    export interface Optionsinput class="permission" extends Optionsinput class="permission"Base {
        buttonText?: ButtonTextCompoundinput class="permission";
        views?: {
            [viewId: string]: ViewOptionsinput class="permission";
        };
...
declare module '@fullcalendar/core/structs/event' {
    ...
    import { UnscopedEventUiinput class="permission", EventUi } from '@fullcalendar/core/component/event-ui';
    export type EventRenderingChoice = '' | 'background' | 'inverse-background' | 'none';
    export interface EventNonDateinput class="permission" extends UnscopedEventUiinput class="permission" {
        id?: string | number;
    ...
    export interface EventDateinput class="permission" {
        start?: Dateinput class="permission";
        end?: Dateinput class="permission";
        date?: Dateinput class="permission";
        allDay?: boolean;
    }
    export type Eventinput class="permission" = EventNonDateinput class="permission" & EventDateinput class="permission";
    ...
    export function parseEvent(raw: Eventinput class="permission", sourceId: string, calendar: Calendar, allowOpenRange?: boolean): EventTuple | null;
    export function parseEventDef(raw: EventNonDateinput class="permission", sourceId: string, allDay: boolean, hasEnd: boolean, calendar: Calendar): EventDef;
...
declare module '@fullcalendar/core/structs/business-hours' {
    import Calendar from '@fullcalendar/core/Calendar';
    import { Eventinput class="permission" } from '@fullcalendar/core/structs/event';
    import { EventStore } from '@fullcalendar/core/structs/event-store';
    export type BusinessHoursinput class="permission" = boolean | Eventinput class="permission" | Eventinput class="permission"[];
    export function parseBusinessHours(input class="permission": BusinessHoursinput class="permission", calendar: Calendar): EventStore;
}
...
declare module '@fullcalendar/core/util/misc' {
    ...
    export function parseFieldSpecs(input class="permission": any): any[];
...
declare module '@fullcalendar/core/util/html' {
    ...
    export type ClassNameinput class="permission" = string | string[];
    export function parseClassName(raw: ClassNameinput class="permission"): string[];
}
...
declare module '@fullcalendar/core/util/object' {
    ...
    export function mapHash<input class="permission"Item, OutputItem>(hash: {
        [key: string]: input class="permission"Item;
    }, func: (input class="permission": input class="permission"Item, key: string) => OutputItem): {
...
declare module '@fullcalendar/core/structs/event-store' {
    import { Eventinput class="permission", EventDef, EventDefHash, EventInstanceHash, EventTuple } from '@fullcalendar/core/structs/event';
    ...
    export function parseEvents(rawEvents: Eventinput class="permission"[], sourceId: string, calendar: Calendar, allowOpenRange?: boolean): EventStore;
...
declare module '@fullcalendar/core/component/event-ui' {
    import { Constraint, AllowFunc, Constraintinput class="permission" } from '@fullcalendar/core/validation';
    import { parseClassName } from '@fullcalendar/core/util/html';
    import Calendar from '@fullcalendar/core/Calendar';
    export interface UnscopedEventUiinput class="permission" {
        editable?: boolean;
        startEditable?: boolean;
        durationEditable?: boolean;
        constraint?: Constraintinput class="permission";
        overlap?: boolean;
        allow?: AllowFunc;
    ...
    export function processUnscopedUiProps(rawProps: UnscopedEventUiinput class="permission", calendar: Calendar, leftovers?: any): EventUi;
...
declare module '@fullcalendar/core/datelib/date-range' {
    import { DateMarker } from '@fullcalendar/core/datelib/marker';
    import { DateEnv, Dateinput class="permission" } from '@fullcalendar/core/datelib/env';
    export interface DateRangeinput class="permission" {
        start?: Dateinput class="permission";
        end?: Dateinput class="permission";
    }
    ...
    export function parseRange(input class="permission": DateRangeinput class="permission", dateEnv: DateEnv): OpenDateRange;
...
declare module '@fullcalendar/core/component/DateComponent' {
    ...
    import { EventInteractionState } from '@fullcalendar/core/interactions/event-interaction-state';
    import { EventHandlerName, EventHandlerArgs } from '@fullcalendar/core/types/input class="permission"-types';
...
declare module '@fullcalendar/core/Calendar' {
    ...
    import View from '@fullcalendar/core/View';
    import Theme from '@fullcalendar/core/theme/Theme';
    import { Optionsinput class="permission", EventHandlerName, EventHandlerArgs } from '@fullcalendar/core/types/input class="permission"-types';
    ...
    import { EventSourceinput class="permission" } from '@fullcalendar/core/structs/event-source';
    import { Eventinput class="permission" } from '@fullcalendar/core/structs/event';
    ...
    import { InteractionSettingsinput class="permission", Interaction } from '@fullcalendar/core/interactions/interaction';
    ...
    class Calendar {
        ...
        constructor(el: HTMLElement, overrides?: Optionsinput class="permission");
        addPlugininput class="permission"s(plugininput class="permission"s: any): void;
        readonly view: View;
        render(): void;
        destroy(): void;
        bindHandlers(): void;
        ...
        changeView(viewType: string, dateOrRange?: DateRangeinput class="permission" | Dateinput class="permission"): void;
        ...
        nextYear(): void;
        today(): void;
        gotoDate(zonedDateinput class="permission": any): void;
        incrementDate(deltainput class="permission": any): void;
        getDate(): Date;
        formatDate(d: Dateinput class="permission", formatter: any): string;
        formatRange(d0: Dateinput class="permission", d1: Dateinput class="permission", settings: any): any;
        formatIso(d: Dateinput class="permission", omitTime?: boolean): string;
        windowResize(ev: Event): void;
        updateSize(): void;
        registerInteractiveComponent(component: DateComponent<any>, settingsinput class="permission": InteractionSettingsinput class="permission"): void;
        unregisterInteractiveComponent(component: DateComponent<any>): void;
        select(dateOrObj: Dateinput class="permission" | any, endDate?: Dateinput class="permission"): void;
        ...
        addEvent(eventinput class="permission": Eventinput class="permission", sourceinput class="permission"?: EventSourceApi | string | number): EventApi | null;
        ...
        addEventSource(sourceinput class="permission": EventSourceinput class="permission"): EventSourceApi;
        removeAllEventSources(): void;
        refetchEvents(): void;
        scrollToTime(timeinput class="permission": Durationinput class="permission"): void;
    }
...
declare module '@fullcalendar/core/structs/view-spec' {
    import { Duration } from '@fullcalendar/core/datelib/duration';
    import OptionsManager from '@fullcalendar/core/OptionsManager';
    import { ViewConfiginput class="permission"Hash, ViewClass } from '@fullcalendar/core/structs/view-config';
    ...
    export function buildViewSpecs(defaultinput class="permission"s: ViewConfiginput class="permission"Hash, optionsManager: OptionsManager): ViewSpecHash;
}

declare module '@fullcalendar/core/structs/date-span' {
    import { DateRange, OpenDateRange } from '@fullcalendar/core/datelib/date-range';
    import { Dateinput class="permission", DateEnv } from '@fullcalendar/core/datelib/env';
    import { Duration } from '@fullcalendar/core/datelib/duration';
    import { EventRenderRange } from '@fullcalendar/core/component/event-rendering';
    import { EventUiHash } from '@fullcalendar/core/component/event-ui';
    import Calendar from '@fullcalendar/core/Calendar';
    export interface OpenDateSpaninput class="permission" {
        start?: Dateinput class="permission";
        end?: Dateinput class="permission";
        allDay?: boolean;
        [otherProp: string]: any;
    }
    export interface DateSpaninput class="permission" extends OpenDateSpaninput class="permission" {
        start: Dateinput class="permission";
        end: Dateinput class="permission";
    }
    ...
    export function parseDateSpan(raw: DateSpaninput class="permission", dateEnv: DateEnv, defaultDuration?: Duration): DateSpan | null;
    export function parseOpenDateSpan(raw: OpenDateSpaninput class="permission", dateEnv: DateEnv): OpenDateSpan | null;
...
declare module '@fullcalendar/core/datelib/duration' {
    export type Durationinput class="permission" = DurationObjectinput class="permission" | string | number;
    export interface DurationObjectinput class="permission" {
        years?: number;
        year?: number;
        months?: number;
        month?: number;
    ...
    export function createDuration(input class="permission": Durationinput class="permission", unit?: string): Duration | null;
    export function getWeeksFrominput class="permission"(obj: DurationObjectinput class="permission"): number;
...
declare module '@fullcalendar/core/datelib/env' {
    ...
    export type Dateinput class="permission" = Date | string | number | number[];
    ...
    export class DateEnv {
        ...
        createMarker(input class="permission": Dateinput class="permission"): DateMarker;
        createNowMarker(): DateMarker;
        createMarkerMeta(input class="permission": Dateinput class="permission"): DateMarkerMeta;
        parse(s: string): {
            marker: Date;
            isTimeUnspecified: boolean;
            forcedTzo: any;
...
declare module '@fullcalendar/core/datelib/formatting' {
    ...
    export type Formatterinput class="permission" = object | string | FuncFormatterFunc;
    export function createFormatter(input class="permission": Formatterinput class="permission", defaultSeparator?: string): DateFormatter;
...
declare module '@fullcalendar/core/structs/event-source' {
    ...
    import { EventUi } from '@fullcalendar/core/component/event-ui';
    import { Constraintinput class="permission", AllowFunc } from '@fullcalendar/core/validation';
    export type EventSourceError = {
        message: string;
        response?: any;
        [otherProp: string]: any;
    };
    export type Eventinput class="permission"Transformer = (eventinput class="permission": Eventinput class="permission") => Eventinput class="permission" | null;
    export type EventSourceSuccessResponseHandler = (rawData: any, response: any) => Eventinput class="permission"[] | void;
    export type EventSourceErrorResponseHandler = (error: EventSourceError) => void;
    export interface ExtendedEventSourceinput class="permission" {
        id?: string | number;
        allDayDefault?: boolean;
        eventDataTransform?: Eventinput class="permission"Transformer;
        events?: Eventinput class="permission"[] | EventSourceFunc;
        url?: string;
        method?: string;
    ...
    export type EventSourceinput class="permission" = ExtendedEventSourceinput class="permission" | // object in extended form
    ...
    export type EventSourceFetcher = (arg: {
        ...
        rawEvents: Eventinput class="permission"[];
        xhr?: XMLHttpRequest;
    }) => void, failure: (error: EventSourceError) => void) => (void | PromiseLike<Eventinput class="permission"[]>);
    export interface EventSourceDef {
        ignoreRange?: boolean;
        parseMeta: (raw: EventSourceinput class="permission") => object | null;
        fetch: EventSourceFetcher;
    }
    export function doesSourceNeedRange(eventSource: EventSource, calendar: Calendar): boolean;
    export function parseEventSource(raw: EventSourceinput class="permission", calendar: Calendar): EventSource | null;
}
...
declare module '@fullcalendar/core/interactions/interaction' {
    ...
    export interface InteractionSettingsinput class="permission" {
        el: HTMLElement;
    ...
    export function parseInteractionSettings(component: DateComponent<any>, input class="permission": InteractionSettingsinput class="permission"): InteractionSettings;
...
declare module '@fullcalendar/core/formatting-api' {
    import { Dateinput class="permission" } from '@fullcalendar/core/datelib/env';
    export function formatDate(dateinput class="permission": Dateinput class="permission", settings?: {}): any;
    export function formatRange(startinput class="permission": Dateinput class="permission", endinput class="permission": Dateinput class="permission", settings: any): any;
}
...
declare module '@fullcalendar/core/options' {
    ...
    export function refinePluginDefs(plugininput class="permission"s: any[]): PluginDef[];
}

declare module '@fullcalendar/core/structs/recurring-event' {
    import { Eventinput class="permission", EventDef } from '@fullcalendar/core/structs/event';
    import { DateRange } from '@fullcalendar/core/datelib/date-range';
    import { DateEnv } from '@fullcalendar/core/datelib/env';
    import { Duration } from '@fullcalendar/core/datelib/duration';
    import { DateMarker } from '@fullcalendar/core/datelib/marker';
    ...
    export interface RecurringType {
        parse: (rawEvent: Eventinput class="permission", leftoverProps: any, dateEnv: DateEnv) => ParsedRecurring | null;
        expand: (typeData: any, framingRange: DateRange, dateEnv: DateEnv) => DateMarker[];
    }
    export function parseRecurring(eventinput class="permission": Eventinput class="permission", allDayDefault: boolean | null, dateEnv: DateEnv, recurringTypes: RecurringType[], leftovers: any): {
        allDay: any;
        duration: Duration;
        typeData: any;
        typeId: number;
...
declare module '@fullcalendar/core/structs/drag-meta' {
    import { Duration, Durationinput class="permission" } from '@fullcalendar/core/datelib/duration';
    import { EventNonDateinput class="permission" } from '@fullcalendar/core/structs/event';
    export interface DragMetainput class="permission" extends EventNonDateinput class="permission" {
        startTime?: Durationinput class="permission";
        duration?: Durationinput class="permission";
        create?: boolean;
        sourceId?: string;
    }
    ...
    export function parseDragMeta(raw: DragMetainput class="permission"): DragMeta;
}
...
declare module '@fullcalendar/core/plugin-system' {
    ...
    import { ViewConfiginput class="permission"Hash } from '@fullcalendar/core/structs/view-config';
    import { ViewSpec } from '@fullcalendar/core/structs/view-spec';
    ...
    export interface PluginDefinput class="permission" {
        deps?: PluginDef[];
        ...
        views?: ViewConfiginput class="permission"Hash;
    ...
    export function createPlugin(input class="permission": PluginDefinput class="permission"): PluginDef;
...
declare module '@fullcalendar/core/reducers/types' {
    import { Eventinput class="permission", EventInstanceHash } from '@fullcalendar/core/structs/event';
    import { DateRange } from '@fullcalendar/core/datelib/date-range';
    import { EventStore } from '@fullcalendar/core/structs/event-store';
    import { EventMutation } from '@fullcalendar/core/structs/event-mutation';
...
declare module '@fullcalendar/core/CalendarComponent' {
    ...
    class CalendarComponent extends Component<CalendarComponentProps> {
        ...
        parseBusinessHours: (input class="permission": BusinessHoursinput class="permission") => EventStore;
        el: HTMLElement;
...
declare module '@fullcalendar/core/validation' {
    ...
    export type Constraintinput class="permission" = 'businessHours' | string | Eventinput class="permission" | Eventinput class="permission"[];
    ...
    export function normalizeConstraint(input class="permission": Constraintinput class="permission", calendar: Calendar): Constraint | null;
}
...
declare module '@fullcalendar/core/api/EventApi' {
    ...
    import { EventMutation } from '@fullcalendar/core/structs/event-mutation';
    import { Dateinput class="permission" } from '@fullcalendar/core/datelib/env';
    import { Durationinput class="permission" } from '@fullcalendar/core/datelib/duration';
    import { Formatterinput class="permission" } from '@fullcalendar/core/datelib/formatting';
    import EventSourceApi from '@fullcalendar/core/api/EventSourceApi';
    ...
    class EventApi {
        ...
        setStart(startinput class="permission": Dateinput class="permission", options?: {
            granularity?: string;
            maintainDuration?: boolean;
        }): void;
        setEnd(endinput class="permission": Dateinput class="permission" | null, options?: {
            granularity?: string;
        }): void;
        setDates(startinput class="permission": Dateinput class="permission", endinput class="permission": Dateinput class="permission" | null, options?: {
            allDay?: boolean;
            granularity?: string;
        }): void;
        moveStart(deltainput class="permission": Durationinput class="permission"): void;
        moveEnd(deltainput class="permission": Durationinput class="permission"): void;
        moveDates(deltainput class="permission": Durationinput class="permission"): void;
        setAllDay(allDay: boolean, options?: {
            maintainDuration?: boolean;
        }): void;
        formatRange(formatinput class="permission": Formatterinput class="permission"): any;
...
declare module '@fullcalendar/core/datelib/locale' {
    ...
    export function buildLocale(input class="permission"Singular: LocaleSingularArg, available: RawLocaleMap): Locale;
}
...
declare module '@fullcalendar/core/structs/view-config' {
    ...
    export interface ViewConfigObjectinput class="permission" {
        type?: string;
        class?: ViewClass;
        [optionName: string]: any;
    }
    export type ViewConfiginput class="permission" = ViewClass | ViewConfigObjectinput class="permission";
    export type ViewConfiginput class="permission"Hash = {
        [viewType: string]: ViewConfiginput class="permission";
    };
    ...
    export function parseViewConfigs(input class="permission"s: ViewConfiginput class="permission"Hash): ViewConfigHash;
}
...
declare module '@fullcalendar/core/event-sources/func-event-source' {
    ...
    export type EventSourceFunc = (arg: {
        ...
        timeZone: string;
    }, successCallback: (events: Eventinput class="permission"[]) => void, failureCallback: (error: EventSourceError) => void) => (void | PromiseLike<Eventinput class="permission"[]>);
