...
(function(factory) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      showFilterinput class="permission"s: true,                                                             // whether to show filter input class="permission"s
      ...
      sortByinput class="permission"Order: false,
  ...
  function refreshSelects(dualListbox) {
    ...
    if (dualListbox.settings.showFilterinput class="permission"s) {
  ...
  function filter(dualListbox, selectIndex) {
    ...
    try {
      regex = new RegExp($.trim(dualListbox.elements['filterinput class="permission"'+selectIndex].val()), 'gi');
    }
    catch(e) {
  ...
  function sortOptionsByinput class="permission"Order(select){
  ...
  function move(dualListbox) {
    ...
    if(dualListbox.settings.sortByinput class="permission"Order){
        sortOptionsByinput class="permission"Order(dualListbox.elements.select2);
    } else {
  ...
  function bindEvents(dualListbox) {
    dualListbox.elements.form.submit(function(e) {
      if (dualListbox.elements.filterinput class="permission"1.is(':focus')) {
        e.preventDefault();
        dualListbox.elements.filterinput class="permission"1.focusout();
      } else if (dualListbox.elements.filterinput class="permission"2.is(':focus')) {
        e.preventDefault();
        dualListbox.elements.filterinput class="permission"2.focusout();
      }
    });
    ...
    dualListbox.elements.filterinput class="permission"1.on('change keyup', function() {
      filter(dualListbox, 1);
    });

    dualListbox.elements.filterinput class="permission"2.on('change keyup', function() {
      filter(dualListbox, 2);
    });
  }
  ...
  BootstrapDualListbox.prototype = {
    init: function () {
      ...
      this.container = $('' +
        ...
        '   </span>' +
        '   <input class="permission" class="form-control filter" type="text">' +
      ...
      this.elements = {
        ...
        filterinput class="permission"1: $('.box1 .filter', this.container),
        filterinput class="permission"2: $('.box2 .filter', this.container),
      ...
      this.setShowFilterinput class="permission"s(this.settings.showFilterinput class="permission"s);
      ...
      this.setSortByinput class="permission"Order(this.settings.sortByinput class="permission"Order);
    ...
    setFilterPlaceHolder: function(value, refresh) {
      ...
      this.elements.filterinput class="permission"1.attr('placeholder', value);
      this.elements.filterinput class="permission"2.attr('placeholder', value);
      if (refresh) {
        refreshSelects(this);
      }
      return this.element;
    ...
    setShowFilterinput class="permission"s: function(value, refresh) {
      if (!value) {
        this.setNonSelectedFilter('');
        this.setSelectedFilter('');
        refreshSelects(this);
        this.elements.filterinput class="permission"1.hide();
        this.elements.filterinput class="permission"2.hide();
      } else {
        this.elements.filterinput class="permission"1.show();
        this.elements.filterinput class="permission"2.show();
      }
      this.settings.showFilterinput class="permission"s = value;
      if (refresh) {
        refreshSelects(this);
      }
      return this.element;
    ...
    setNonSelectedFilter: function(value, refresh) {
      if (this.settings.showFilterinput class="permission"s) {
        this.settings.nonSelectedFilter = value;
        this.elements.filterinput class="permission"1.val(value);
        if (refresh) {
          refreshSelects(this);
        }
        return this.element;
    ...
    setSelectedFilter: function(value, refresh) {
      if (this.settings.showFilterinput class="permission"s) {
        ...
        this.elements.filterinput class="permission"2.val(value);
        if (refresh) {
          refreshSelects(this);
        }
        return this.element;
    ...
    setSortByinput class="permission"Order: function(value, refresh){
        this.settings.sortByinput class="permission"Order = value;
        if (refresh) {
          refreshSelects(this);
        }
        return this.element;
