...
WHERE id_vag= '$id_vag'";
	...
	function get_liste_by_filter_show($icode, $id_vag,$nom_secteur)
	{
		if ($icode == 111) {
			if ($id_vag == 111) {
				if($nom_secteur == 111){
					...
					$sql = " SELECT *
               FROM liste_bac1
			   where  id_deleted = 0 and code_etab='$nom_secteur'
			   ...
			   ";
				...
				if($nom_secteur == 111){
					$sql = " SELECT *
					FROM liste_bac1
					where  id_deleted = 0 and id_vag ='$id_vag'
					...
					$sql = " SELECT *
               FROM liste_bac1
			   where  id_deleted = 0 and id_vag ='$id_vag' and code_etab='$nom_secteur'
			...
			if ($id_vag == 111) {
				...
				$sql = " SELECT *
               FROM liste_bac1
			   where ICODE='$icode' and id_deleted = 0 and code_etab='$nom_secteur'
			   ...
			   ORDER BY id ASC
				...
				if($nom_secteur == 111){
					$sql = " SELECT *
					FROM liste_bac1
					where ICODE='$icode' and id_deleted = 0 and id_vag='$id_vag' 
					ORDER BY id ASC
					 ";
				}else{
				$sql = " SELECT *
               FROM liste_bac1
			   where ICODE='$icode' and id_deleted = 0 and id_vag='$id_vag' and code_etab='$nom_secteur'
			   ORDER BY id ASC
                ";
				}
			}
	...
	function get_liste_by_filter($icode, $id_vag,$nom_secteur)
	{
		if ($icode == 111) {
			if ($id_vag == 111) {
				$sql = " SELECT *
	...
	function get_liste_by_filter_one($icode, $id_vag,$nom_secteur)
	{
		if ($icode == 111) {
			$sql = " SELECT *
               FROM liste_bac1
