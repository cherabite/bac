			...
			<form id="form_add_f" method="post" action="<?php echo base_url('c_fournisseur/update_fournisseur') ?>">
						...
						<div class="row">
							<div class=" col-md-12">
								<h4 class="text-center "><span class="fa fa-shopping-cart " style="color:#99ff33"></span>
									&nbsp;<strong class="text-uppercase"> تعديل بيانات متعامل </strong> </h4>
							</div>
					...
					<div class="card-body">
						<div class="row">
						  ...
						  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><i class=" glyphicon glyphicon-remove-circle"></i><span aria-hidden="true"></span></button>';
									...
									<div class="form-group row">
										<label for="example-email-input" class="col-2 col-form-label"> الشكل القانوني
											:</label>
										<div class="col-10">
									...
									<div class="form-group row">
										<label for="example-email-input" class="col-2 col-form-label"> القطاع القانوني
											:</label>
										<div class="col-10">
				...
				<div class="shdw-p card-footer clearfix">
					<div class="float-left">
						...
						<div>
							<button type="submit" class=" btn btn3d btn-primary" id="valid">&nbsp; موافق <i class="fa fa-check"></i> </button>
						</div>
					</div>
				</div>
		</div>
