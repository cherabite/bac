<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <form method="post" action="<?php echo base_url('c_chapitre_article/update_chapitre') ?>" >
                ...
                <div class="card border-dark ">
                        ...
                        <div class="row">
                            <div class=" col-md-12">
                                <h4 class="text-center "><span class="fa fa-edit " style="color:#99ff33"></span>
                                    &nbsp;<strong class="text-uppercase"> تعديل على الباب </strong> </h4>
                            </div>
					...
					?>
                                    ...
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-2 col-form-label">الفــصـل :</label>
                                        <div class="col-10">
                                            <select class="form-control" name="pknum_section">
                                                <option value="<?php echo $chapitre->pknum_section ?>">
                                                    <?php echo $chapitre->pknum_section .'   '.$chapitre->libelle_section ?>
                                                </option>
                                                <?php
											if ($sections) {
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" type="text"
                                                value="<?php echo $chapitre->pknum_chapitre ?>"
                                                id="pknum_chapitre"    name="pknum_chapitre">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="example-email-input" class="col-2 col-form-label">تعيين الباب
                                            :</label>
                                        <div class="col-10">
                                            <input class="form-control" type="text"
                                                value="<?php echo $chapitre->libelle_chapitre ?>"
                                                id="libelle_chapitre" name="libelle_chapitre">
                                        </div>
                                    </div>
                                    <input type="hidden" name="id_chapitre" value="<?php echo $chapitre->id_chapitre ?>"  > 
