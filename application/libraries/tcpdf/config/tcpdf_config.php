 ...
 */
define ('K_PATH_MAIN', 'application/libraries/tcpdf/');

/**
 * URL path to tcpdf installation folder (http://localhost/tcpdf/).
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
define ('K_PATH_URL', 'http://inscriptic.onefd.edu.dz/application/libraries/tcpdf/');
...
define ('PDF_PAGE_ORIENTATION_P', 'P');
define ('PDF_PAGE_ORIENTATION_L', 'L');
